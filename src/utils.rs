...
{} search - Search for a shortcut pack"#,
        format!("shortkut {}", "1.0.0".bright_green()),
        "*".bright_magenta().bold(),
        "*".bright_magenta().bold(),
        "*".bright_magenta().bold(),
        "*".bright_magenta().bold(),
    ...
    match args.len() {
        ...
        2 => {
            if args[1] == "--version" {
                println!("shortkut version {}", "1.0.0".bright_green().bold())
            } else if args[1] == "--help" {
                // Display Help Menu
                println!("{}", help);
            } else {
...
links:
  ...
  "#,
        ...
        _ => {
            println!(
                "{}: shortkut recieved unexpected arguments",
                "error".bright_red().bold()
            );
        }
    }
